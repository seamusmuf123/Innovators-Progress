...
from backend.users.analyst_routes import analyst_bp
from backend.users.desk_attendant_routes import desk_bp
from backend.users.system_admin_routes import sysadmin_bp
...
def create_app():
    ...
    # Register user-related blueprints (users, analysts, desk attendants, system admins)
